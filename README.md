...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create kanjisense-cf4b
  fly apps create kanjisense-cf4b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app kanjisense-cf4b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app kanjisense-cf4b-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'kanjisense-cf4b-staging' does not match app name in config file 'kanjisense-cf4b'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name kanjisense-cf4b-db
  fly postgres attach --app kanjisense-cf4b kanjisense-cf4b-db

  fly postgres create --name kanjisense-cf4b-staging-db
  fly postgres attach --app kanjisense-cf4b-staging kanjisense-cf4b-staging-db
  ```
